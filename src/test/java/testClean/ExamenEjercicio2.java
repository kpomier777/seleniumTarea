...
public class ExamenEjercicio2 extends TestBaseTodoLy {
    ...
    public void verify_create_project_todoly() throws InterruptedException {
        ...
        this.waitOnSecond(2);
        leftSection.basurero.click();
        leftSection.openmenurecicly.click();
        projectOptionsPage.deleteallBasurero.click();
        this.waitOnSecond(2);
        Assert.assertEquals("Basurero no vacio","There are no items to display", centerSection.basurerovacio.getText());
